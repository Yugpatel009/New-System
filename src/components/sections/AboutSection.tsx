        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-cyber max-w-3xl mx-auto leading-relaxed">
              Engineered at the intersection of advanced hardware and adaptive software,
              this system integrates real-time data processing, embedded intelligence, and
              scalable architecture. It is designed to learn, self-optimize, and deliver
              seamless performance across next-generation computing environments.
            </p>
          </motion.div>
              ...
              <div className="glass-card p-8 rounded-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-rajdhani text-foreground/90">
                      Specialization in Embedded Systems & Edge Computing
                    </span>
                  </div>
                </div>
              </div>
          ...
          >
            {[
              ...
              { number: "10+", label: "HARDWARE PROTOTYPES" },
